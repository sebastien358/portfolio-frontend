...
import FormationCreate from "@/features/admin/formation/views/FormationCreate.vue";
import FormationList from "@/features/admin/formation/views/FormationList.vue";
import FormationUpdate from "@/features/admin/formation/views/FormationUpdate.vue";
...
export const ADMIN_ROUTES: RouteRecordRaw[] = [
    ...
    {path: '/admin/formation-list', name: 'admin-formation-list', meta: {isAdmin: true}, component: FormationList},
    {path: '/admin/formation-create', name: 'admin-formation-create', meta: {isAdmin: true}, component: FormationCreate},
    {path: '/admin/formation-update/:id', name: 'admin-formation-update', meta: {isAdmin: true}, component: FormationUpdate}
]