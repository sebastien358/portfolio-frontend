...
export const useExperienceAdminStore = defineStore('experienceAdminStore', {
    ...
    actions: {
        ...
        async getExperiences() {
            try {
                const response = await axios.get(`https://api.dymawonder.fr/admin/experience/list`, {
                    headers: {
        ...
        async getCurrentExperience(id: number) {
            try {
                const response = await axios.get(`https://api.dymawonder.fr/admin/experience/details/${id}`, {
                    headers: {
                        Authorization: 'Bearer ' + sessionStorage.getItem('token')
                    }
                })
        ...
        async experienceCreate(pictures: Object) {
            ...
            try {
                await axios.post(`https://api.dymawonder.fr/admin/experience/new`, formData,{
                    headers: {
                        Authorization: 'Bearer ' + sessionStorage.getItem('token')
                    }
                })
        ...
        async updateExperience(id: number, pictures: Object) {
            ...
            try {
                const response = await axios.post(`https://api.dymawonder.fr/admin/experience/update/${id}`, formData,{
                    headers: {
                        Authorization: 'Bearer ' + sessionStorage.getItem('token')
                    }
                })
